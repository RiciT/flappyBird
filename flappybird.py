...
def draw_win(win, birds, pipes, base, score, gen, alivebirds):
	win.blit(BG_IMG, (0,0))
	for pipe in pipes:
		pipe.draw(win)
	...
	win.blit(text, (10, 10))
	text = STAT_FONT.render("Alive birds: " + str(alivebirds), 1, (255, 255, 255))
	win.blit(text, (10, 25))
	base.draw(win)
...
def main(genomes, config):
	...
	while run:
		...
		base.move()
		draw_win(win, birds, pipes, base, score, GEN, ALIVE_BIRDS)
